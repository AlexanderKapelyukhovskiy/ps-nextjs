              ...
              <div className="card col-4 cardmin">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    and agile success. While вЂњself-organizingвЂќ does not mean
                    no managers, the old manager roles and rules no longer
                    apply. This session is about manager roles that make agile
                    teams thrive
                  </p>
                </div>
              </div>
